...
def database():
    ...
    # NUMBER, cherry NUMBER, nacho_fries NUMBER, pizza NUMBER, biscuit NUMBER, roll NUMBER, tea NUMBER, cost_NUMBER,
...
first_frame.grid(row=1, column=0, padx=20, pady=20)
...
second_frame.grid(row=1, column=1, padx=20, pady=20)
...
third_frame.grid(row=1, column=2, padx=20, pady=20)

calc_entry = Entry(third_frame, font="Caliber 19", borderwidth=4)
calc_entry.grid(row=0, column=0, pady=5, padx=5, columnspan=4)
...
fourth_frame.grid(row=2, column=0, padx=20, pady=20, columnspan=2)
...
submit.grid(row=2, column=3, padx=20)
